...
export function MongestService<T extends EntityPayload, IdType = ObjectId>(
  EntityClass: Type<T>,
): AbstractType<IMongestService<T, IdType>> {
  @Injectable()
  abstract class BaseServiceHost implements IMongestService<T, IdType> {
